...
# homelab.io/homelab-assistant-bundle:$VERSION and homelab.io/homelab-assistant-catalog:$VERSION.
IMAGE_TAG_BASE ?= homelab.io/homelab-assistant
...
chart-install-local: chart-package ## Install charts locally for testing
	...
	@helm upgrade --install homelab-assistant dist/homelab-assistant-*.tgz \
