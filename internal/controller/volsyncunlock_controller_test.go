...
var _ = Describe("VolSyncUnlock Controller", func() {
	Context("When reconciling a resource", func() {
		...
		BeforeEach(func() {
			By("creating the custom resource for the Kind VolSyncUnlock")
			err := k8sClient.Get(ctx, typeNamespacedName, volsyncunlock)
		...
		It("should successfully reconcile the resource", func() {
			...
			controllerReconciler := &VolSyncUnlockReconciler{
				Client: k8sClient,
